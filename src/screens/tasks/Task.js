...
const Task = () => {
  ...
  const [taskList, setTaskList] = useState(tasks.filter(task => task.date === today))
  // console.log(date)
  ...
  return (
    <SafeAreaView style={styles.container}>
      <CalendarStrip
        ...
        daySelectionAnimation={{ type: 'border', duration: 100, borderHighlightColor: COLORS.white, borderWidth: 1 }}
      ...
      <View style={styles.filterContainer}>
        <TouchableOpacity style={[styles.filterItem, filter === "All" ? styles.activeFilterItem : styles.inactiveFilterItem]}
          onPress={() => setFilter("All")}>
          <Text style={[styles.filterText, filter === "All" ? styles.activeFilterText : styles.inactiveFilterText]}>All</Text>
        </TouchableOpacity>

        <TouchableOpacity style={[styles.filterItem, filter === "To do" ? styles.activeFilterItem : styles.inactiveFilterItem]}
          onPress={() => setFilter("To do")}>
          <Text style={[styles.filterText, filter === "To do" ? styles.activeFilterText : styles.inactiveFilterText]}>To do</Text>
        </TouchableOpacity>

        <TouchableOpacity style={[styles.filterItem, filter === "Completed" ? styles.activeFilterItem : styles.inactiveFilterItem]}
          onPress={() => setFilter("Completed")}>
          <Text style={[styles.filterText, filter === "Completed" ? styles.activeFilterText : styles.inactiveFilterText]}>Completed</Text>
        </TouchableOpacity>
      </View>
